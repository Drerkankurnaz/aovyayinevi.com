...
<div id="pageWrapper">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 pt-lg-23 pt-md-15 pt-sm-10 pt-6 text-center">
                        <h1 class="headingIV fwEbold playfair mb-4">Yayınlarımız</h1>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4 featureCol mb-7">
                                <div class="border">
                                    <div class="imgHolder position-relative w-100 overflow-hidden">
                                        <img src="{{asset('storage/'.$book->photo)}}" alt="AOV Yayinevi" class="img-fluid w-100">
                                        <ul class="list-unstyled postHoverLinskList d-flex justify-content-center m-0">
                                            <li class="mr-2 overflow-hidden"><a href="{{route('kitap', ['id' => $book->id])}}" class="icon-eye d-block"></a></li>
                                        </ul>
                                    </div>
                                    <div class="text-center py-5 px-4">
                                        <span class="title d-block mb-2"><a href="{{route('kitap', ['id' => $book->id])}}">{{$book->title}}</a></span>
                                        <span class="price d-block fwEbold">{{$book->price}}</span>
                                    </div>
                                </div>
                            </div>
                        @endforeach
    ...
    <footer id="footer" class="container-fluid overflow-hidden px-lg-20">
        <div class="copyRightHolder text-center pt-lg-5 pb-lg-4 py-3">
            <p class="mb-0">Coppyright 2023 by <a href="javascript:void(0);">E-DMS STUDIO | TezerArge</a> - Tüm hakları saklıdır.</p>
        </div>
    </footer>
</div>
